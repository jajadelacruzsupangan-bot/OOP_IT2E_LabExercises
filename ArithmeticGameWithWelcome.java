...
class WelcomeScreen extends JFrame {
    public WelcomeScreen() {
        ...
        getContentPane().setBackground(new Color(255, 228, 196)); // Nude background
        ...
        startButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                new ArithmeticGame(); // open main game
...
class ArithmeticGame extends JFrame {
    ...
    public ArithmeticGame() {
        ...
        setSize(1000, 550);
        setLayout(new BorderLayout());
        getContentPane().setBackground(new Color(245, 222, 179)); // Nude background
    ...
    private void endGame() {
        ...
        dispose();
        new WelcomeScreen(); // Return to main screen
    }
}
